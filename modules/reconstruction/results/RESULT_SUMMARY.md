...
| --- | --- | ---: | ---: | ---: |
| `amtown02_baseline/probe_force_cuda.splat` | splat | 0.34 | - | - |
| `amtown02_baseline/probe_force_cuda_preload.splat` | splat | 0.34 | - | - |
| `amtown02_baseline/probe_force_cuda_wsl.splat` | splat | 0.34 | - | - |
| `amtown02_baseline/probe_gpu.splat` | splat | 0.34 | - | - |
| `amtown02_baseline/probe_gpu2.splat` | splat | 0.34 | - | - |
| `amtown02_baseline/probe_gpu_no_cublas_ws.splat` | splat | 1.09 | - | - |
| `amtown02_baseline/scene_from_existing_run.ply` | ply | 7.10 | 500 | 30000 |
| `amtown02_baseline/scene_small_cpu.ply` | ply | 2.61 | 300 | 11016 |
| `amtown02_baseline/scene_small_cpu.splat` | splat | 0.34 | - | - |
| `amtown02_colmap_s6_4k.ply` | ply | 39.20 | 4000 | 165728 |
| `amtown02_gpu_docker_smoke.splat` | splat | 1.09 | - | - |
| `amtown02_gpu_final.ply` | ply | 29.98 | 2000 | 126758 |
| `amtown02_gpu_final.splat` | splat | 3.88 | - | - |
| `amtown02_gpu_final_1000.ply` | ply | 29.98 | 1000 | 126758 |
| `amtown02_gpu_final_1000.splat` | splat | 3.88 | - | - |
| `amtown02_gpu_final_1500.ply` | ply | 29.98 | 1500 | 126758 |
| `amtown02_gpu_final_1500.splat` | splat | 3.88 | - | - |
| `amtown02_gpu_final_2000.ply` | ply | 29.98 | 2000 | 126758 |
| `amtown02_gpu_final_2000.splat` | splat | 3.88 | - | - |
| `amtown02_gpu_final_500.ply` | ply | 8.44 | 500 | 35679 |
| `amtown02_gpu_final_500.splat` | splat | 1.09 | - | - |
| `amtown02_quality_balanced.ply` | ply | 166.57 | 8000 | 704292 |
| `amtown02_quality_balanced_2000.ply` | ply | 56.46 | 2000 | 238718 |
...
| `amtown02_vo_refined_2000/scene_gpu_safe_n2000_d3.ply` | ply | 3.09 | 2000 | 31190 |
...
| `amtown02_vo_safe/scene_gpu_safe_n500_d3.ply` | ply | 1.09 | 500 | 11016 |
| `cpu_check.splat` | splat | 1.09 | - | - |
...
| `amtown02_vo_refined_2000/cameras.json` | 65 |
